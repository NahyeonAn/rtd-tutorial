"""
simsep - Python library for PSA simulation.
"""
...
class column:
 ...
 ### Before running the simulations ###
    ...
    def adsorbent_info(self, iso_fn, epsi = 0.3, D_particle = 0.01, rho_s = 1000,P_test_range=[0,10], T_test_range = [273,373]):
        """Set adsorbent information.
        
        :param iso_fn: Isotherm function.
        :param epsi: porosity of adsorbent.
